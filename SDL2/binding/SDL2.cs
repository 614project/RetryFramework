...
internal static class SDL
{
    ...
    /// <returns>성공 시 0을 반환하거나 실패 시 음수 오류 코드를 반환합니다.</returns>
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
...
#pragma warning restore 0169
	...
	{
		return (SDL_Keycode)((int)X | SCANCODE_MASK);
	}
    ...
    public enum SDL_Keycode
	{
		...
		*/
		...
		SDLK_CAPSLOCK = (int)SDL_Scancode.SDL_SCANCODE_CAPSLOCK | SCANCODE_MASK,

		SDLK_F1 = (int)SDL_Scancode.SDL_SCANCODE_F1 | SCANCODE_MASK,
		SDLK_F2 = (int)SDL_Scancode.SDL_SCANCODE_F2 | SCANCODE_MASK,
		SDLK_F3 = (int)SDL_Scancode.SDL_SCANCODE_F3 | SCANCODE_MASK,
		SDLK_F4 = (int)SDL_Scancode.SDL_SCANCODE_F4 | SCANCODE_MASK,
		SDLK_F5 = (int)SDL_Scancode.SDL_SCANCODE_F5 | SCANCODE_MASK,
		SDLK_F6 = (int)SDL_Scancode.SDL_SCANCODE_F6 | SCANCODE_MASK,
		SDLK_F7 = (int)SDL_Scancode.SDL_SCANCODE_F7 | SCANCODE_MASK,
		SDLK_F8 = (int)SDL_Scancode.SDL_SCANCODE_F8 | SCANCODE_MASK,
		SDLK_F9 = (int)SDL_Scancode.SDL_SCANCODE_F9 | SCANCODE_MASK,
		SDLK_F10 = (int)SDL_Scancode.SDL_SCANCODE_F10 | SCANCODE_MASK,
		SDLK_F11 = (int)SDL_Scancode.SDL_SCANCODE_F11 | SCANCODE_MASK,
		SDLK_F12 = (int)SDL_Scancode.SDL_SCANCODE_F12 | SCANCODE_MASK,

		SDLK_PRINTSCREEN = (int)SDL_Scancode.SDL_SCANCODE_PRINTSCREEN | SCANCODE_MASK,
		SDLK_SCROLLLOCK = (int)SDL_Scancode.SDL_SCANCODE_SCROLLLOCK | SCANCODE_MASK,
		SDLK_PAUSE = (int)SDL_Scancode.SDL_SCANCODE_PAUSE | SCANCODE_MASK,
		SDLK_INSERT = (int)SDL_Scancode.SDL_SCANCODE_INSERT | SCANCODE_MASK,
		SDLK_HOME = (int)SDL_Scancode.SDL_SCANCODE_HOME | SCANCODE_MASK,
		SDLK_PAGEUP = (int)SDL_Scancode.SDL_SCANCODE_PAGEUP | SCANCODE_MASK,
		SDLK_DELETE = 127,
		SDLK_END = (int)SDL_Scancode.SDL_SCANCODE_END | SCANCODE_MASK,
		SDLK_PAGEDOWN = (int)SDL_Scancode.SDL_SCANCODE_PAGEDOWN | SCANCODE_MASK,
		SDLK_RIGHT = (int)SDL_Scancode.SDL_SCANCODE_RIGHT | SCANCODE_MASK,
		SDLK_LEFT = (int)SDL_Scancode.SDL_SCANCODE_LEFT | SCANCODE_MASK,
		SDLK_DOWN = (int)SDL_Scancode.SDL_SCANCODE_DOWN | SCANCODE_MASK,
		SDLK_UP = (int)SDL_Scancode.SDL_SCANCODE_UP | SCANCODE_MASK,

		SDLK_NUMLOCKCLEAR = (int)SDL_Scancode.SDL_SCANCODE_NUMLOCKCLEAR | SCANCODE_MASK,
		SDLK_KP_DIVIDE = (int)SDL_Scancode.SDL_SCANCODE_KP_DIVIDE | SCANCODE_MASK,
		SDLK_KP_MULTIPLY = (int)SDL_Scancode.SDL_SCANCODE_KP_MULTIPLY | SCANCODE_MASK,
		SDLK_KP_MINUS = (int)SDL_Scancode.SDL_SCANCODE_KP_MINUS | SCANCODE_MASK,
		SDLK_KP_PLUS = (int)SDL_Scancode.SDL_SCANCODE_KP_PLUS | SCANCODE_MASK,
		SDLK_KP_ENTER = (int)SDL_Scancode.SDL_SCANCODE_KP_ENTER | SCANCODE_MASK,
		SDLK_KP_1 = (int)SDL_Scancode.SDL_SCANCODE_KP_1 | SCANCODE_MASK,
		SDLK_KP_2 = (int)SDL_Scancode.SDL_SCANCODE_KP_2 | SCANCODE_MASK,
		SDLK_KP_3 = (int)SDL_Scancode.SDL_SCANCODE_KP_3 | SCANCODE_MASK,
		SDLK_KP_4 = (int)SDL_Scancode.SDL_SCANCODE_KP_4 | SCANCODE_MASK,
		SDLK_KP_5 = (int)SDL_Scancode.SDL_SCANCODE_KP_5 | SCANCODE_MASK,
		SDLK_KP_6 = (int)SDL_Scancode.SDL_SCANCODE_KP_6 | SCANCODE_MASK,
		SDLK_KP_7 = (int)SDL_Scancode.SDL_SCANCODE_KP_7 | SCANCODE_MASK,
		SDLK_KP_8 = (int)SDL_Scancode.SDL_SCANCODE_KP_8 | SCANCODE_MASK,
		SDLK_KP_9 = (int)SDL_Scancode.SDL_SCANCODE_KP_9 | SCANCODE_MASK,
		SDLK_KP_0 = (int)SDL_Scancode.SDL_SCANCODE_KP_0 | SCANCODE_MASK,
		SDLK_KP_PERIOD = (int)SDL_Scancode.SDL_SCANCODE_KP_PERIOD | SCANCODE_MASK,

		SDLK_APPLICATION = (int)SDL_Scancode.SDL_SCANCODE_APPLICATION | SCANCODE_MASK,
		SDLK_POWER = (int)SDL_Scancode.SDL_SCANCODE_POWER | SCANCODE_MASK,
		SDLK_KP_EQUALS = (int)SDL_Scancode.SDL_SCANCODE_KP_EQUALS | SCANCODE_MASK,
		SDLK_F13 = (int)SDL_Scancode.SDL_SCANCODE_F13 | SCANCODE_MASK,
		SDLK_F14 = (int)SDL_Scancode.SDL_SCANCODE_F14 | SCANCODE_MASK,
		SDLK_F15 = (int)SDL_Scancode.SDL_SCANCODE_F15 | SCANCODE_MASK,
		SDLK_F16 = (int)SDL_Scancode.SDL_SCANCODE_F16 | SCANCODE_MASK,
		SDLK_F17 = (int)SDL_Scancode.SDL_SCANCODE_F17 | SCANCODE_MASK,
		SDLK_F18 = (int)SDL_Scancode.SDL_SCANCODE_F18 | SCANCODE_MASK,
		SDLK_F19 = (int)SDL_Scancode.SDL_SCANCODE_F19 | SCANCODE_MASK,
		SDLK_F20 = (int)SDL_Scancode.SDL_SCANCODE_F20 | SCANCODE_MASK,
		SDLK_F21 = (int)SDL_Scancode.SDL_SCANCODE_F21 | SCANCODE_MASK,
		SDLK_F22 = (int)SDL_Scancode.SDL_SCANCODE_F22 | SCANCODE_MASK,
		SDLK_F23 = (int)SDL_Scancode.SDL_SCANCODE_F23 | SCANCODE_MASK,
		SDLK_F24 = (int)SDL_Scancode.SDL_SCANCODE_F24 | SCANCODE_MASK,
		SDLK_EXECUTE = (int)SDL_Scancode.SDL_SCANCODE_EXECUTE | SCANCODE_MASK,
		SDLK_HELP = (int)SDL_Scancode.SDL_SCANCODE_HELP | SCANCODE_MASK,
		SDLK_MENU = (int)SDL_Scancode.SDL_SCANCODE_MENU | SCANCODE_MASK,
		SDLK_SELECT = (int)SDL_Scancode.SDL_SCANCODE_SELECT | SCANCODE_MASK,
		SDLK_STOP = (int)SDL_Scancode.SDL_SCANCODE_STOP | SCANCODE_MASK,
		SDLK_AGAIN = (int)SDL_Scancode.SDL_SCANCODE_AGAIN | SCANCODE_MASK,
		SDLK_UNDO = (int)SDL_Scancode.SDL_SCANCODE_UNDO | SCANCODE_MASK,
		SDLK_CUT = (int)SDL_Scancode.SDL_SCANCODE_CUT | SCANCODE_MASK,
		SDLK_COPY = (int)SDL_Scancode.SDL_SCANCODE_COPY | SCANCODE_MASK,
		SDLK_PASTE = (int)SDL_Scancode.SDL_SCANCODE_PASTE | SCANCODE_MASK,
		SDLK_FIND = (int)SDL_Scancode.SDL_SCANCODE_FIND | SCANCODE_MASK,
		SDLK_MUTE = (int)SDL_Scancode.SDL_SCANCODE_MUTE | SCANCODE_MASK,
		SDLK_VOLUMEUP = (int)SDL_Scancode.SDL_SCANCODE_VOLUMEUP | SCANCODE_MASK,
		SDLK_VOLUMEDOWN = (int)SDL_Scancode.SDL_SCANCODE_VOLUMEDOWN | SCANCODE_MASK,
		SDLK_KP_COMMA = (int)SDL_Scancode.SDL_SCANCODE_KP_COMMA | SCANCODE_MASK,
		SDLK_KP_EQUALSAS400 =
		(int)SDL_Scancode.SDL_SCANCODE_KP_EQUALSAS400 | SCANCODE_MASK,

		SDLK_ALTERASE = (int)SDL_Scancode.SDL_SCANCODE_ALTERASE | SCANCODE_MASK,
		SDLK_SYSREQ = (int)SDL_Scancode.SDL_SCANCODE_SYSREQ | SCANCODE_MASK,
		SDLK_CANCEL = (int)SDL_Scancode.SDL_SCANCODE_CANCEL | SCANCODE_MASK,
		SDLK_CLEAR = (int)SDL_Scancode.SDL_SCANCODE_CLEAR | SCANCODE_MASK,
		SDLK_PRIOR = (int)SDL_Scancode.SDL_SCANCODE_PRIOR | SCANCODE_MASK,
		SDLK_RETURN2 = (int)SDL_Scancode.SDL_SCANCODE_RETURN2 | SCANCODE_MASK,
		SDLK_SEPARATOR = (int)SDL_Scancode.SDL_SCANCODE_SEPARATOR | SCANCODE_MASK,
		SDLK_OUT = (int)SDL_Scancode.SDL_SCANCODE_OUT | SCANCODE_MASK,
		SDLK_OPER = (int)SDL_Scancode.SDL_SCANCODE_OPER | SCANCODE_MASK,
		SDLK_CLEARAGAIN = (int)SDL_Scancode.SDL_SCANCODE_CLEARAGAIN | SCANCODE_MASK,
		SDLK_CRSEL = (int)SDL_Scancode.SDL_SCANCODE_CRSEL | SCANCODE_MASK,
		SDLK_EXSEL = (int)SDL_Scancode.SDL_SCANCODE_EXSEL | SCANCODE_MASK,

		SDLK_KP_00 = (int)SDL_Scancode.SDL_SCANCODE_KP_00 | SCANCODE_MASK,
		SDLK_KP_000 = (int)SDL_Scancode.SDL_SCANCODE_KP_000 | SCANCODE_MASK,
		...
		SDLK_CURRENCYUNIT = (int)SDL_Scancode.SDL_SCANCODE_CURRENCYUNIT | SCANCODE_MASK,
		SDLK_CURRENCYSUBUNIT =
		(int)SDL_Scancode.SDL_SCANCODE_CURRENCYSUBUNIT | SCANCODE_MASK,
		SDLK_KP_LEFTPAREN = (int)SDL_Scancode.SDL_SCANCODE_KP_LEFTPAREN | SCANCODE_MASK,
		SDLK_KP_RIGHTPAREN = (int)SDL_Scancode.SDL_SCANCODE_KP_RIGHTPAREN | SCANCODE_MASK,
		SDLK_KP_LEFTBRACE = (int)SDL_Scancode.SDL_SCANCODE_KP_LEFTBRACE | SCANCODE_MASK,
		SDLK_KP_RIGHTBRACE = (int)SDL_Scancode.SDL_SCANCODE_KP_RIGHTBRACE | SCANCODE_MASK,
		SDLK_KP_TAB = (int)SDL_Scancode.SDL_SCANCODE_KP_TAB | SCANCODE_MASK,
		SDLK_KP_BACKSPACE = (int)SDL_Scancode.SDL_SCANCODE_KP_BACKSPACE | SCANCODE_MASK,
		SDLK_KP_A = (int)SDL_Scancode.SDL_SCANCODE_KP_A | SCANCODE_MASK,
		SDLK_KP_B = (int)SDL_Scancode.SDL_SCANCODE_KP_B | SCANCODE_MASK,
		SDLK_KP_C = (int)SDL_Scancode.SDL_SCANCODE_KP_C | SCANCODE_MASK,
		SDLK_KP_D = (int)SDL_Scancode.SDL_SCANCODE_KP_D | SCANCODE_MASK,
		SDLK_KP_E = (int)SDL_Scancode.SDL_SCANCODE_KP_E | SCANCODE_MASK,
		SDLK_KP_F = (int)SDL_Scancode.SDL_SCANCODE_KP_F | SCANCODE_MASK,
		SDLK_KP_XOR = (int)SDL_Scancode.SDL_SCANCODE_KP_XOR | SCANCODE_MASK,
		SDLK_KP_POWER = (int)SDL_Scancode.SDL_SCANCODE_KP_POWER | SCANCODE_MASK,
		SDLK_KP_PERCENT = (int)SDL_Scancode.SDL_SCANCODE_KP_PERCENT | SCANCODE_MASK,
		SDLK_KP_LESS = (int)SDL_Scancode.SDL_SCANCODE_KP_LESS | SCANCODE_MASK,
		SDLK_KP_GREATER = (int)SDL_Scancode.SDL_SCANCODE_KP_GREATER | SCANCODE_MASK,
		SDLK_KP_AMPERSAND = (int)SDL_Scancode.SDL_SCANCODE_KP_AMPERSAND | SCANCODE_MASK,
		...
		SDLK_KP_COLON = (int)SDL_Scancode.SDL_SCANCODE_KP_COLON | SCANCODE_MASK,
		SDLK_KP_HASH = (int)SDL_Scancode.SDL_SCANCODE_KP_HASH | SCANCODE_MASK,
		SDLK_KP_SPACE = (int)SDL_Scancode.SDL_SCANCODE_KP_SPACE | SCANCODE_MASK,
		SDLK_KP_AT = (int)SDL_Scancode.SDL_SCANCODE_KP_AT | SCANCODE_MASK,
		SDLK_KP_EXCLAM = (int)SDL_Scancode.SDL_SCANCODE_KP_EXCLAM | SCANCODE_MASK,
		SDLK_KP_MEMSTORE = (int)SDL_Scancode.SDL_SCANCODE_KP_MEMSTORE | SCANCODE_MASK,
		SDLK_KP_MEMRECALL = (int)SDL_Scancode.SDL_SCANCODE_KP_MEMRECALL | SCANCODE_MASK,
		SDLK_KP_MEMCLEAR = (int)SDL_Scancode.SDL_SCANCODE_KP_MEMCLEAR | SCANCODE_MASK,
		SDLK_KP_MEMADD = (int)SDL_Scancode.SDL_SCANCODE_KP_MEMADD | SCANCODE_MASK,
		SDLK_KP_MEMSUBTRACT =
		(int)SDL_Scancode.SDL_SCANCODE_KP_MEMSUBTRACT | SCANCODE_MASK,
		SDLK_KP_MEMMULTIPLY =
		(int)SDL_Scancode.SDL_SCANCODE_KP_MEMMULTIPLY | SCANCODE_MASK,
		SDLK_KP_MEMDIVIDE = (int)SDL_Scancode.SDL_SCANCODE_KP_MEMDIVIDE | SCANCODE_MASK,
		SDLK_KP_PLUSMINUS = (int)SDL_Scancode.SDL_SCANCODE_KP_PLUSMINUS | SCANCODE_MASK,
		SDLK_KP_CLEAR = (int)SDL_Scancode.SDL_SCANCODE_KP_CLEAR | SCANCODE_MASK,
		SDLK_KP_CLEARENTRY = (int)SDL_Scancode.SDL_SCANCODE_KP_CLEARENTRY | SCANCODE_MASK,
		SDLK_KP_BINARY = (int)SDL_Scancode.SDL_SCANCODE_KP_BINARY | SCANCODE_MASK,
		SDLK_KP_OCTAL = (int)SDL_Scancode.SDL_SCANCODE_KP_OCTAL | SCANCODE_MASK,
		SDLK_KP_DECIMAL = (int)SDL_Scancode.SDL_SCANCODE_KP_DECIMAL | SCANCODE_MASK,
		SDLK_KP_HEXADECIMAL =
		(int)SDL_Scancode.SDL_SCANCODE_KP_HEXADECIMAL | SCANCODE_MASK,

		SDLK_LCTRL = (int)SDL_Scancode.SDL_SCANCODE_LCTRL | SCANCODE_MASK,
		SDLK_LSHIFT = (int)SDL_Scancode.SDL_SCANCODE_LSHIFT | SCANCODE_MASK,
		SDLK_LALT = (int)SDL_Scancode.SDL_SCANCODE_LALT | SCANCODE_MASK,
		SDLK_LGUI = (int)SDL_Scancode.SDL_SCANCODE_LGUI | SCANCODE_MASK,
		SDLK_RCTRL = (int)SDL_Scancode.SDL_SCANCODE_RCTRL | SCANCODE_MASK,
		SDLK_RSHIFT = (int)SDL_Scancode.SDL_SCANCODE_RSHIFT | SCANCODE_MASK,
		SDLK_RALT = (int)SDL_Scancode.SDL_SCANCODE_RALT | SCANCODE_MASK,
		SDLK_RGUI = (int)SDL_Scancode.SDL_SCANCODE_RGUI | SCANCODE_MASK,

		SDLK_MODE = (int)SDL_Scancode.SDL_SCANCODE_MODE | SCANCODE_MASK,

		SDLK_AUDIONEXT = (int)SDL_Scancode.SDL_SCANCODE_AUDIONEXT | SCANCODE_MASK,
		SDLK_AUDIOPREV = (int)SDL_Scancode.SDL_SCANCODE_AUDIOPREV | SCANCODE_MASK,
		SDLK_AUDIOSTOP = (int)SDL_Scancode.SDL_SCANCODE_AUDIOSTOP | SCANCODE_MASK,
		SDLK_AUDIOPLAY = (int)SDL_Scancode.SDL_SCANCODE_AUDIOPLAY | SCANCODE_MASK,
		SDLK_AUDIOMUTE = (int)SDL_Scancode.SDL_SCANCODE_AUDIOMUTE | SCANCODE_MASK,
		SDLK_MEDIASELECT = (int)SDL_Scancode.SDL_SCANCODE_MEDIASELECT | SCANCODE_MASK,
		SDLK_WWW = (int)SDL_Scancode.SDL_SCANCODE_WWW | SCANCODE_MASK,
		SDLK_MAIL = (int)SDL_Scancode.SDL_SCANCODE_MAIL | SCANCODE_MASK,
		SDLK_CALCULATOR = (int)SDL_Scancode.SDL_SCANCODE_CALCULATOR | SCANCODE_MASK,
		SDLK_COMPUTER = (int)SDL_Scancode.SDL_SCANCODE_COMPUTER | SCANCODE_MASK,
		SDLK_AC_SEARCH = (int)SDL_Scancode.SDL_SCANCODE_AC_SEARCH | SCANCODE_MASK,
		SDLK_AC_HOME = (int)SDL_Scancode.SDL_SCANCODE_AC_HOME | SCANCODE_MASK,
		SDLK_AC_BACK = (int)SDL_Scancode.SDL_SCANCODE_AC_BACK | SCANCODE_MASK,
		SDLK_AC_FORWARD = (int)SDL_Scancode.SDL_SCANCODE_AC_FORWARD | SCANCODE_MASK,
		SDLK_AC_STOP = (int)SDL_Scancode.SDL_SCANCODE_AC_STOP | SCANCODE_MASK,
		SDLK_AC_REFRESH = (int)SDL_Scancode.SDL_SCANCODE_AC_REFRESH | SCANCODE_MASK,
		SDLK_AC_BOOKMARKS = (int)SDL_Scancode.SDL_SCANCODE_AC_BOOKMARKS | SCANCODE_MASK,

		SDLK_BRIGHTNESSDOWN =
		(int)SDL_Scancode.SDL_SCANCODE_BRIGHTNESSDOWN | SCANCODE_MASK,
		SDLK_BRIGHTNESSUP = (int)SDL_Scancode.SDL_SCANCODE_BRIGHTNESSUP | SCANCODE_MASK,
		SDLK_DISPLAYSWITCH = (int)SDL_Scancode.SDL_SCANCODE_DISPLAYSWITCH | SCANCODE_MASK,
		SDLK_KBDILLUMTOGGLE =
		(int)SDL_Scancode.SDL_SCANCODE_KBDILLUMTOGGLE | SCANCODE_MASK,
		SDLK_KBDILLUMDOWN = (int)SDL_Scancode.SDL_SCANCODE_KBDILLUMDOWN | SCANCODE_MASK,
		SDLK_KBDILLUMUP = (int)SDL_Scancode.SDL_SCANCODE_KBDILLUMUP | SCANCODE_MASK,
		SDLK_EJECT = (int)SDL_Scancode.SDL_SCANCODE_EJECT | SCANCODE_MASK,
		SDLK_SLEEP = (int)SDL_Scancode.SDL_SCANCODE_SLEEP | SCANCODE_MASK,
		SDLK_APP1 = (int)SDL_Scancode.SDL_SCANCODE_APP1 | SCANCODE_MASK,
		SDLK_APP2 = (int)SDL_Scancode.SDL_SCANCODE_APP2 | SCANCODE_MASK,

		SDLK_AUDIOREWIND = (int)SDL_Scancode.SDL_SCANCODE_AUDIOREWIND | SCANCODE_MASK,
		SDLK_AUDIOFASTFORWARD = (int)SDL_Scancode.SDL_SCANCODE_AUDIOFASTFORWARD | SCANCODE_MASK
	}
	...
	#region Add_by_614
	[DllImport(nativeLibName, EntryPoint = "SDL_ResetKeyboard", CallingConvention = CallingConvention.Cdecl)]
